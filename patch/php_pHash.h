...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(ph_image_digest_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 1)
  ZEND_ARG_INFO(0, file)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
#define ph_image_digest_arg_info NULL
#endif
...
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(ph_compare_image_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 2)
  ZEND_ARG_INFO(0, a)
  ZEND_ARG_INFO(0, b)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
#define ph_compare_image_arg_info NULL
#endif

#if HAVE_IMAGE_HASH
PHP_FUNCTION(ph_dct_imagehash_to_array);
#if (PHP_MAJOR_VERSION >= 5)
ZEND_BEGIN_ARG_INFO_EX(ph_dct_imagehash_to_array_arg_info, ZEND_SEND_BY_VAL, ZEND_RETURN_VALUE, 1)
  ZEND_ARG_INFO(0, h)
ZEND_END_ARG_INFO()
#else /* PHP 4.x */
#define ph_dct_imagehash_to_array_arg_info NULL
#endif
